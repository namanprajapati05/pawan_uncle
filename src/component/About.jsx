  ...
  return (
    ...
    <div className={style.about}>
      ...
      <div className="defination">
        <h1 className={style.heading}>Interpretation and Definitions</h1>
        <p>
          Interpretation <br />
        ...
        <ul>
          ...
          <li>
            ...
            this Agreement) refers to PAWNMUTT CREDIT CO OPERATIVE SOCIETY
            LIMITED, 69, Rajendra Marg, Madhu Nagar, Madhu Nagar, Madhya
            Pradesh, India.
          </li>
          ...
          <li>
            Website refers to GLETUS TECHNOLOGY, accessible from
            http://gletus.com
          </li>
          <li>
      ...
      <div className="third_part">
        ...
        <p>
          ...
          contact list associated with that account. You also have the option of
          ...
          such information and Personal Data, You are granting the Company
      ...
      <div className="tracking">
        <h1 className={style.heading}>Tracking Technologies and Cookies</h1>
        <p>
        ...
        <ul>
          ...
          <li>
            ...
            deleting local shared objects?" available at the Adobe website.
          </li>
          <li>
      ...
      <div className={style.use}>
        <h1 className={style.heading}>Use of Your Personal Data</h1>
      ...
      <div className="personal_data">
        <h1 className={style.heading}>Retention of Your Personal Data</h1>
      ...
      <div className="transfer_personal_data">
        <h1 className={style.heading}>Transfer of Your Personal Data</h1>
      ...
      <div className="delete_personal_data">
        <h1 className={style.heading}>Delete Your Personal Data</h1>
        <p>
      ...
      <div className="disclosure">
        <h1 className={style.heading}>Disclosure of Your Personal Data</h1>
      ...
      <div className="security">
        <h1 className={style.heading}>Security of Your Personal Data</h1>
        <p>
      ...
      <div className="children">
        <h1 className={style.heading}>Children's Privacy</h1>
        <p>
      ...
      <div className="links">
        <h1 className={style.heading}>Links to Other Websites</h1>
      ...
      <div className="change">
        <h1 className={style.heading}>Changes to this Privacy Policy</h1>
        <p>
      ...
      <div className="contect">
        ...
        <ul>
          <li>By email: gletustechnology@gmail.com</li>
          <li>By visiting this page on our website: http://gletus.com</li>
          <li>By phone number: +91-9981881517</li>
        </ul>
      </div>
      </div>  
    </>
